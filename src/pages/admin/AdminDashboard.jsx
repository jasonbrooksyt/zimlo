...
import { LogOut, Package, Clock, CheckCircle2 } from 'lucide-react'
import { useStore } from '../../store/useStore'
import { ORDER_STAGES, COD_FEE } from '../../data/menuData'

// Admin dashboard — lists every order across Food and all request-based
// categories. For request-based orders (no fixed price), admin enters a
// price and chosen payment method to confirm it. For all orders, admin can
// move the order through delivery stages.
