...
export default function SideDrawer({ open, onClose }) {
  ...
  const items = [
    ...
    { icon: Shield, label: t('गोपनीयता नीति', 'Privacy Policy'), path: '/privacy-policy' },
    { icon: FileText, label: t('नियम व शर्तें', 'Terms & Conditions'), path: '/terms' },
    { icon: RotateCcw, label: t('रिफंड नीति', 'Refund Policy'), path: '/refund-policy' },
    { icon: Truck, label: t('डिलीवरी नीति', 'Delivery Policy'), path: '/delivery-policy' }
